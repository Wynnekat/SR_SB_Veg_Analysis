...
bray_curtis_cover_bank.plot <- ggplot()+
  geom_jitter(data=cover_bank_dis_results, aes(x = Site, y = dissimilarity_bray, color = Site), show.legend = FALSE, width = .2, size = 2) +
...
bray_curtis_rain_bank.plot <- ggplot()+
  geom_jitter(data=rain_bank_dis_results, aes(x = Site, y = dissimilarity_bray, color = Site), show.legend = FALSE, width = .2, size = 2) +
